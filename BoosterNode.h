...
#define multiByteResponse   "{\"Cmd\":%s,\"Prm\":{\"Src\":%i,\"Opc\":%i,\"Addr\":%i,\"Vals\":[%i,%i,%i,%i]}}\n"
//#define singleByteResponse "{\"Cmd\":%s,\"Prm\":{\"Src\":%i,\"Opc\":%i,\"Addr\":%i,\"Vals\":[%i]}}\n"
...
//#define quadWordResponse   "{\"Cmd\":%s,\"Prm\":{\"Src\":%i,\"Opc\":%i,\"Addr\":%i,\"Vals\":[%i,%i,%i,%i]}}\n"
//#define scTestResponse "{\"Cmd\":\"SCV\",\"Prm\":{\"Src\":%i,\"Opc\":%i,\"Addr\":%i,\"Vals\":[%i,%i,%i,%i]}}\n"
...
typedef struct
{
  ...
  uint32_t scVal; //aggregated short circuit current reading value
